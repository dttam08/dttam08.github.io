...
<title><?php echo $title; ?>｜町田市の歯医者｜ワイズデンタルオフィス</title>
<?php
	if($keywords_Value){
?>
...
?>
  <meta name="description" content="町田市の歯医者「ワイズデンタルオフィス」のお知らせ・ブログはこちらをご覧ください。当院のお休みやお口の健康に役立つ情報などを日々発信しています。お時間がありましたら、お気軽にチェックしていただけますと幸いです。" />
<?php
	}
?>
...
<div id="wrapper">
   ...
   <header id="header">
    <div class="container">
      <h1 class="logo"><a href="https://www.ys-dental.com/"><img loading="lazy" src="../../images/logo.jpg" alt="町田市の歯医者「ワイズデンタルオフィス」、「<?php echo $title; ?>」のページです。"></a></h1>
      <div class="h_right">
        <div class="h_info">
  ...
  <main id="main">
    <div id="mainvisual">
      <div class="container">
        <h2><?php echo mb_strimwidth($title, 0, 50, '…', 'UTF-8'); ?></h2>
      </div>
    </div>
    <ul class="topic_path">
      <li><a href="https://www.ys-dental.com/">Home</a></li>
      ...
      <li><?php echo mb_strimwidth($title, 0, 50, '…', 'UTF-8'); ?></li>
    </ul>
    <div id="content">
...
?>
	...
	if($image1_Value){
?>
              <p class="image_l information_img"><img src="<?php echo $image1_Src; ?>" alt="<?php echo $title; ?>" /></p>
            <?php
	}
?>
...
?>
	...
	if($image1_Value){
?>
              <p class="center information_img"><img src="<?php echo $image1_Src; ?>" alt="<?php echo $title; ?>" /></p>
            <?php
	}
?>
          <?php
...
?>
        ...
        <p class="information_btn"><a href="../">戻る</a></p>
      </section>
      <div>
