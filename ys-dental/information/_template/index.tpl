...
<title>{=$base_title=}｜町田市の歯医者｜ワイズデンタルオフィス</title>
<meta name="keywords" content="お知らせ,ブログ,休み,情報">
<meta name="description" content="町田市の歯医者「ワイズデンタルオフィス」の{=$base_title=}はこちらをご覧ください。当院のお休みやお口の健康に役立つ情報などを日々発信しています。お時間がありましたら、お気軽にチェックしていただけますと幸いです。">
...
<div id="wrapper">
  <!--header-->
   <header id="header">
    <div class="container">
      <h1 class="logo"><a href="https://www.ys-dental.com/"><img loading="lazy" src="../images/logo.jpg" alt="町田市の歯医者「ワイズデンタルオフィス」、「{=$base_title=}」のページです。"></a></h1>
      <div class="h_right">
        <div class="h_info">
