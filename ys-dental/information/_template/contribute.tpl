...
<title>{=$title=}｜町田市の歯医者｜ワイズデンタルオフィス</title>
...
<div id="wrapper">
   ...
   <header id="header">
    <div class="container">
      <h1 class="logo"><a href="https://www.ys-dental.com/"><img loading="lazy" src="../../images/logo.jpg" alt="町田市の歯医者「ワイズデンタルオフィス」、「{=$title=}」のページです。"></a></h1>
      <div class="h_right">
        <div class="h_info">
  ...
  <main id="main">
    <div id="mainvisual">
      <div class="container">
        <h2>{=mb_strimwidth($title, 0, 50, '…', 'UTF-8')=}</h2>
      </div>
    </div>
    <ul class="topic_path">
      <li><a href="https://www.ys-dental.com/">Home</a></li>
      ...
      <li>{=mb_strimwidth($title, 0, 50, '…', 'UTF-8')=}</li>
    </ul>
    <div id="content">
        ...
        <div class="mb30 clearfix">
          <ONIf condition="$text1_Value">
            <ONIf condition="$image1_Value">
              <p class="image_l information_img"><img src="{=$image1_Src=}" alt="{=$title=}" /></p>
            </ONIf>
            {=$text1_Value=}
            <ONElse>
            <ONIf condition="$image1_Value">
              <p class="center information_img"><img src="{=$image1_Src=}" alt="{=$title=}" /></p>
            </ONIf>
          </ONIf>
        </div>
