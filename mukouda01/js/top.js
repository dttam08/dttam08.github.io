            ...
            $.ajax({
                ...
                success: function(json) {
                    $.each(json.data, function(i, val) {
                        ...
                        var html = '<li><span class="date">' + convertDate(val.date) + '</span><span class="cate cate0' + val.category_id + '">' + val.category_name + '</span><a href="column/' + val.url + '" class="ttl">' + ttl + '</a></li>';
                        $('.idx_b01_tab_cts #tab01').append(html);
                    });
                }
            });
            // //NEWS
            $.ajax({
                ...
                success: function(json) {
                    $.each(json.data, function(i, val) {
                        ...
                        ttl = ttl.length < 45 ? ttl : ttl.substr(0, 45) + '...';
                        var html = '<li><span class="date">' + convertDate(val.date) + '</span><span class="cate cate0' + val.category_id + '">' + val.category_name + '</span><a href="column/' + val.url + '" class="ttl">' + ttl + '</a></li>';
                        $('.idx_b01_tab_cts #tab02').append(html);
                    });
                }
            });
            // //BLOG
            $.ajax({
                ...
                success: function(json) {
                    $.each(json.data, function(i, val) {
                        ...
                        ttl = ttl.length < 45 ? ttl : ttl.substr(0, 45) + '...';
                        var html = '<li><span class="date">' + convertDate(val.date) + '</span><span class="cate cate0' + val.category_id + '">' + val.category_name + '</span><a href="column/' + val.url + '" class="ttl">' + ttl + '</a></li>';
                        $('.idx_b01_tab_cts #tab03').append(html);
                    });
                }
            });
            ...
            $.ajax({
                ...
                'success': function(json) {
                    $.each(json.data, function(i, val) {
                        ...
                        var cate = val.txt04 ? '<p class="cate"><span>' + val.txt04 + '</span></p>' : '';
