...
$(window).on('load resize', function(){
    ...
    var vW = $(window).width();
    if (vW > 640) {
        $('#js-parallaxContent .box06').addClass('js-parallaxSection js-section');
        ...
        $('#js-parallaxContent .box06').removeClass('js-parallaxSection js-section');
        console.log('111');
    }
    ...
    $('.idx-btn-skip a').click(function(e) {
        
        $('.parallaxContent .js-section').each(function(i) {
            $(this).addClass('is-active');
            $(this).addClass('is-fixed');
            $(this).css('top', parallaxSectionFirstTop[i]);
            $(this).find('.js-categoryTitle').addClass('is-active');
            $(this).find('.js-categoryDetail').addClass('is-active');
            $(this).find('.js-categoryBanner').addClass('is-active');
        });
        var top = $('#idx-b01').offset().top;
        console.log(top);
        $('html, body').animate(function() {
          scrollTop: parseInt($('#idx-b01').offset().top)
        }, 500);
        e.preventDefault();
//        totop_click = true;
//        toTopEvent();
